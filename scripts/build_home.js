...
function buildIndex() {
  ...
  <section class="relative bg-brand-dark text-white overflow-hidden">
    ...
    <div class="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 md:py-24 lg:py-28">
      <div class="flex flex-col lg:flex-row items-center justify-between gap-10 lg:gap-8">
        ...
        <!-- CỘT TRÁI (W: 7/12) -->
        <div class="w-full lg:w-7/12 pr-0 lg:pr-6 space-y-6">
          ...
          <h1 class="text-3xl md:text-4xl lg:text-[40px] font-bold leading-tight tracking-tight text-white mb-4">
            Xưởng Sản Xuất Pallet Gỗ Trực Tiếp <br/>
            <span class="text-amber-400">Giá Gốc Không Qua Trung Gian</span>
          </h1>
          ...
          <div class="space-y-4 pt-2">
            <div class="flex flex-wrap items-center gap-4">
              <button onclick="openQuickQuoteModal()" class="bg-brand-accent hover:bg-orange-600 text-white text-base font-bold px-7 py-4 rounded-xl shadow-xl hover:shadow-orange-600/30 transition duration-200 flex items-center gap-3">
            ...
            <div>
              <a href="gioi-thieu.html" class="inline-flex items-center gap-2 text-sm text-gray-300 hover:text-amber-400 font-medium transition underline underline-offset-4">
                <i class="fa-solid fa-file-arrow-down text-amber-400 text-base"></i>
        ...
        <div class="w-full lg:w-5/12">
          <div class="bg-white text-gray-800 rounded-2xl p-6 sm:p-7 shadow-2xl border-2 border-amber-500/80 relative">
            ...
            <form data-b2b-form="hero-quick-quote" class="space-y-3.5">
              <div>
                ...
                <select class="w-full text-xs px-3.5 py-2.5 rounded-lg border border-gray-300 focus:ring-2 focus:ring-brand outline-none bg-gray-50">
              ...
              <button type="submit" class="w-full bg-brand hover:bg-brand-dark text-white font-bold py-3.5 rounded-xl transition shadow">
  ...
  <section class="py-16 md:py-20 bg-gray-50 border-t border-b border-gray-200">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-5 gap-4">
        <div class="bg-white p-6 rounded-2xl border border-gray-200 text-center"><div class="w-12 h-12 bg-emerald-100 text-emerald-800 font-bold rounded-full flex items-center justify-center text-lg mx-auto mb-4">1</div><h3 class="font-bold text-gray-900 text-base mb-2">Tiếp Nhận Yêu Cầu</h3><p class="text-xs text-gray-600">Khảo sát tải trọng, kệ hàng và xe nâng.</p></div>
  ...
  <section class="py-16 md:py-20 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div class="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-6 gap-4 text-center font-bold text-gray-400 text-sm mb-12">
        <div class="bg-white p-5 rounded-xl border border-gray-100 shadow-sm hover:border-emerald-200 hover:text-emerald-800 transition-colors tracking-wider flex items-center justify-center">VSIP GROUP</div>
        <div class="bg-white p-5 rounded-xl border border-gray-100 shadow-sm hover:border-emerald-200 hover:text-emerald-800 transition-colors tracking-wider flex items-center justify-center">SÓNG THẦN LOG</div>
        <div class="bg-white p-5 rounded-xl border border-gray-100 shadow-sm hover:border-emerald-200 hover:text-emerald-800 transition-colors tracking-wider flex items-center justify-center">AMATA CORP</div>
        <div class="bg-white p-5 rounded-xl border border-gray-100 shadow-sm hover:border-emerald-200 hover:text-emerald-800 transition-colors tracking-wider flex items-center justify-center">SAMSUNG FDI</div>
        <div class="bg-white p-5 rounded-xl border border-gray-100 shadow-sm hover:border-emerald-200 hover:text-emerald-800 transition-colors tracking-wider flex items-center justify-center">FOXCONN VN</div>
        <div class="bg-white p-5 rounded-xl border border-gray-100 shadow-sm hover:border-emerald-200 hover:text-emerald-800 transition-colors tracking-wider flex items-center justify-center">CP GROUP</div>
      </div>
    </div>
  </section>
  `;
